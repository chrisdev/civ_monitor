...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VolumeReportSubmissionLog'
        db.create_table('funds_volumereportsubmissionlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('volume_report_submission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='volume_report_submission', to=orm['funds.VolumeReportSubmission'])),
            ('passed', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('status_message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('funds', ['VolumeReportSubmissionLog'])


    def backwards(self, orm):
        # Deleting model 'VolumeReportSubmissionLog'
        db.delete_table('funds_volumereportsubmissionlog')
