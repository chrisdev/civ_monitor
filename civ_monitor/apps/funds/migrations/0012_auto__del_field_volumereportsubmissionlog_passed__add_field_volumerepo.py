...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VolumeReportSubmissionLog.passed'
        db.delete_column('funds_volumereportsubmissionlog', 'passed')

        # Adding field 'VolumeReportSubmissionLog.status'
        db.add_column('funds_volumereportsubmissionlog', 'status',
                      self.gf('django.db.models.fields.CharField')(default='passed', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VolumeReportSubmissionLog.passed'
        db.add_column('funds_volumereportsubmissionlog', 'passed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'VolumeReportSubmissionLog.status'
        db.delete_column('funds_volumereportsubmissionlog', 'status')
    ...
    models = {
        ...
        'funds.volumereportsubmission': {
            'Meta': {'object_name': 'VolumeReportSubmission'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'data_period': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['publications.Monthly']"}),
            'filepath': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issuer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['funds.Issuer']"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'uploaded_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'})
        },
        'funds.volumereportsubmissionlog': {
            'Meta': {'object_name': 'VolumeReportSubmissionLog'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'passed'", 'max_length': '20'}),
            'status_message': ('django.db.models.fields.TextField', [], {}),
            'volume_report_submission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'volume_report_submission'", 'to': "orm['funds.VolumeReportSubmission']"})
        },
