...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Issuer.issuer_legacy_id'
        db.delete_column(u'funds_issuer', 'issuer_legacy_id')

        # Adding field 'Issuer.legacy_id'
        db.add_column(u'funds_issuer', 'legacy_id',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Issuer.issuer_legacy_id'
        db.add_column(u'funds_issuer', 'issuer_legacy_id',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Deleting field 'Issuer.legacy_id'
        db.delete_column(u'funds_issuer', 'legacy_id')
    ...
    models = {
        ...
        'funds.issuer': {
            ...
            'legacy_id': ('django.db.models.fields.IntegerField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
