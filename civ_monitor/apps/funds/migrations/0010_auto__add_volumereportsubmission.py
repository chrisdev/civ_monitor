...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VolumeReportSubmission'
        db.create_table('funds_volumereportsubmission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('issuer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['funds.Issuer'])),
            ...
            ('data_period', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publications.Monthly'])),
        ))
        db.send_create_signal('funds', ['VolumeReportSubmission'])


    def backwards(self, orm):
        # Deleting model 'VolumeReportSubmission'
        db.delete_table('funds_volumereportsubmission')
