...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LegalStatus.code'
        db.add_column(u'funds_legalstatus', 'code',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LegalStatus.code'
        db.delete_column(u'funds_legalstatus', 'code')
